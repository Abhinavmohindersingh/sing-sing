...
export const translations = {
  en: {
    ...
    heroSecondary: "Run AI Assessment",
    ...
    problems: [
      {
        ...
        description: "Operations consume your time, leaving no room for strategic growth.",
      ...
      },
      {
        ...
        description: "Growth requires expensive headcount instead of smart systems.",
    ...
    solutions: [
      {
        ...
        features: ["Client onboarding", "Task prioritisation", "Performance tracking"],
      },
      {
        title: "Data-Driven Decisions",
        description: "Custom AI analytics reveal hidden growth opportunities.",
        features: ["Revenue forecasting", "Customer insights", "Competitive intel"],
      },
      {
    ...
    phases: [
      ...
      },
      {
        ...
        description: "Your AI gets smarter and understands you better over time.",
    ...
    faqs: [
      { q: "How fast do we see results?", a: "Right when you talk to us and we start building your AI helpers, you'll see quick wins fast. Most people notice real changes in just 30 days!" },
      { q: "Will this mess up my work?", a: "Nope! We run everything side-by-side so your business keeps going smooth - no interruptions at all." },
      { q: "What businesses do you help?", a: "We help accountants, real estate agents, marketing teams, doctors, online stores, and anyone stuck doing boring repeat work." },
      { q: "Do I need to be techy?", a: "No way! Our screens are easy to use and everything runs automatically - anyone on your team can do it." },
      { q: "Is my info safe?", a: "Totally safe! We use bank-level protection that's ready for all the big privacy rules." },
    ],
    // CTA Section
    ctaTitle: "Ready to Grow Smarter?",
    ctaDescription: "Start your free AI assessment. 2 minutes to personalised growth roadmap.",
    ...
    footerDescription: "AI-powered business transformation for ambitious companies.",
